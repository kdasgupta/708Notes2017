...
\author{Dion O'Neale\\
	with additional content from Nicola Gujer (especially the figures) and Utsav Patel (correcting various sign errors)}
\begin{document}
\maketitle
\tableofcontents
...
%The saddle method states that the exponential with the maxima value dominates the other exponentials and can thus, be "taken out".
